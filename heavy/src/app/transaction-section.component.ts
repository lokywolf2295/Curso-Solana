...
@Component({
    selector: 'heavy-transactions-section',
    ...
    <mat-card class="w-[600px] px-4 py-8">
        ...
        @if (!transactions()) {
            ...
            <td mat-cell *matCellDef="let element">{{ element.actions[0].info.amount }}</td>
            </ng-container>
...
export class TransactionsSectionComponent {
    ...
    displayedColumns: string[] = ['type','amount', 'status', 'timestamp'];
}